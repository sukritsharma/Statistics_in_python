...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 23:03:47 2021
...
data_paths=[['tCho/tNAA as feature with mean Threshold','saved_files/Grade_map_1/RFECV_RF_single_feature_hotspot_mean_filter/'],
            ['tCho/tNAA as feature with max Threshold','saved_files/Grade_map_1/RFECV_RF_single_feature_hotspot_max_filter/'],
            ['tCho/tNAA as feature with min Threshold','saved_files/Grade_map_1/RFECV_RF_single_feature_hotspot_min_filter/'],
            ['tCho/tNAA as feature without Threshold','saved_files/Grade_map_1/RFECV_RF_single_feature_without_threshold/'],
            
            ['Without Threshold','saved_files/Grade_map_1/RFECV_RF_without_threshold/'],
            ['With Threshold Min','saved_files/Grade_map_1/RFECV_RF_hotspot_min_filter/'],
            ['With Threshold Max','saved_files/Grade_map_1/RFECV_RF_hotspot_max_filter/'],
            ['With Threshold Mean','saved_files/Grade_map_1/RFECV_RF_hotspot_mean_filter/'],
...
for data_path in data_paths:
    ...
    predictions_probability=csv_file['High Grade Percent']/100
    AUC=auc(fpr,tpr)
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title(label='ROC Patientwise based on Grade Prediction Probability')
# show the legend
plt.legend(loc=4)
# show the plot
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title(label='ROC Patientwise based on Mean Grade Prediction')
# show the legend
plt.legend(loc=4)
# show the plot
...
fig_roc_voxelwise.savefig('saved_files/images/fig_roc_voxelwise_grade_01.png')
fig_roc_patientwise.savefig('saved_files/images/fig_roc_Grade_Prediction_probability_grade_01.png')
fig_roc_patientwise_mean.savefig('saved_files/images/fig_roc_patientwise_mean_grade_01.png')
